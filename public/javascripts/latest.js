// Last time updated at Oct 18, 2014, 08:32:23
...
connection.privileges = {
    canManuallyPermitRemoteActions: '*' // initiator or * or comma-separated-userids
};

connection.onRemoteAction = function(event) {
    event.userid || event.extra

    if(event.actionName == 'addStream') {
        event.arguments.session = {
            audio: true
        };
        event.continue();
